const { gmd, copyFolderSync } = require("../black_hat");
...
gmd(
    ...
    async (from, Gifted, conText) => {
        ...
        try {
            ...
            const zipPath = path.join(__dirname, "..", "black-hat-md-main.zip"); // Replace this  with your bot name and branch if you're cloning
            ...
            const excludeList = [
                ".env",
                "black_hat/database/database.db",
                "black_hat/session/session.db",
            ];
